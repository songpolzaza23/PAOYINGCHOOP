...
class ScoreTotalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewModelFactory = ScoreTotalViewModelFactory(dataSource, application)
        val scoreTotalViewModel = ViewModelProviders.of(this , viewModelFactory).get(ScoreTotalViewModel::class.java)
        ...
        scoreTotalViewModel.history.observe(viewLifecycleOwner, Observer {
            it.let {
                adapter.data = it
            }
        })
